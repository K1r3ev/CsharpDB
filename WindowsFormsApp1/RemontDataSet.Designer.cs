...
namespace WindowsFormsApp1 {
    ...
    public partial class RemontDataSet : global::System.Data.DataSet {
        ...
        public partial class REQUESTDataTable : global::System.Data.TypedTableBase<REQUESTRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public REQUESTRow AddREQUESTRow(string Description, string Stage, string Responsible) {
...
namespace WindowsFormsApp1.RemontDataSetTableAdapters {
    ...
    public partial class REQUESTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[REQUEST] WHERE (([id] = @Original_id) AND ([Description] = @Or" +
                "iginal_Description) AND ([Stage] = @Original_Stage) AND ([Responsible] = @Origin" +
                "al_Responsible))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[REQUEST] ([Description], [Stage], [Responsible]) VALUES (@Desc" +
                "ription, @Stage, @Responsible);\r\nSELECT id, Description, Stage, Responsible FROM" +
                " REQUEST WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[REQUEST] SET [Description] = @Description, [Stage] = @Stage, [Responsible] = @Responsible WHERE (([id] = @Original_id) AND ([Description] = @Original_Description) AND ([Stage] = @Original_Stage) AND ([Responsible] = @Original_Responsible));
SELECT id, Description, Stage, Responsible FROM REQUEST WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Description, Stage, Responsible FROM dbo.REQUEST";
        ...
        public virtual int Delete(int Original_id, string Original_Description, string Original_Stage, string Original_Responsible) {
        ...
        public virtual int Insert(string Description, string Stage, string Responsible) {
            if ((Description == null)) {
        ...
        public virtual int Update(string Description, string Stage, string Responsible, int Original_id, string Original_Description, string Original_Stage, string Original_Responsible, int id) {
            if ((Description == null)) {
                throw new global::System.ArgumentNullException("Description");
            }
            else {
            ...
            if ((Original_Stage == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_Stage));
            }
            if ((Original_Responsible == null)) {
                throw new global::System.ArgumentNullException("Original_Responsible");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_Responsible));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Description, string Stage, string Responsible, int Original_id, string Original_Description, string Original_Stage, string Original_Responsible) {
            return this.Update(Description, Stage, Responsible, Original_id, Original_Description, Original_Stage, Original_Responsible, Original_id);
        }
    }
